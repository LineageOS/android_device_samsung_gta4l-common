...
Return<Result> PrimaryDevice::setMode(AudioMode mode) {
    ...
    // Audio param g_call_state 2 corresponds to CALL_ACTIVE and 1 to CALL_INACTIVE respectively,
    // both of which can be found in {QC_AUDIO_HAL}/hal/voice.h.
    mDevice->halSetParameters(mode == AudioMode::IN_CALL ? "g_call_state=2"
                                                         : "g_call_state=1");
